Spraycan.Views.Files.Edit = Backbone.View.extend({
  ...
  render: function() {
    var compiled = JST["spraycan/templates/selector/files/tweaker_edit"];
    ...
    _.each(['logo_file_name', 'background_file_name'], function(pref){
      ...
      var uploader = new qq.FileUploader({
        ...
        onComplete: function(id, fileName, responseJSON){
          ...
          Spraycan.preferences[pref] = Spraycan.public_file_path + responseJSON.filename;
    ...
    var uploader = new qq.FileUploader({
      element: document.getElementById('favicon_file_name_uploader'),
      action: '/spraycan/themes/' + Spraycan.theme_id + '/files.json',
      template: '<div class="qq-uploader">' +
              '<div class="qq-upload-drop-area"><span>Drop image here to upload.</span></div>' +
              '<a href="#" class="qq-upload-button">Upload Image</a>' +
      ...
      onComplete: function(id, fileName, responseJSON){
        Spraycan.rollback.preferences.favicon_file_name_uploader = Spraycan.preferences.favicon_file_name_uploader
        Spraycan.preferences.favicon_file_name_uploader = Spraycan.public_file_path + responseJSON.filename;
